...
MCP defaults are conservative: tools are assumed writable, potentially destructive, non-idempotent, and open-world unless you say otherwise. Set hints only when the property is accurate for the implementation.
