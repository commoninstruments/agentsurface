...
- MCP Apps — the first official MCP extension (SEP-1865, Stable `2026-01-26`) — add interactive UI surfaces inside compatible clients (ChatGPT, Claude, VS Code, Goose, Postman)
...
The current specification version is [`2025-11-25`](https://modelcontextprotocol.io/specification/2025-11-25/). This page covers that version.

<Callout type="info">
  A release candidate for revision `2026-07-28` — the largest change since MCP launched — is in
  progress. It introduces a **stateless protocol core** (removing the `initialize` handshake and
  `Mcp-Session-Id`), a **formal extensions framework**, OAuth 2.0 / OIDC hardening, a deprecation
  lifecycle (12-month minimum), JSON Schema 2020-12 tool schemas, and W3C Trace Context. It lands
  2026-07-28; this guide tracks `2025-11-25` and will be updated after the release. Do not build
  against the moving RC.
</Callout>
...
- [MCP Specification 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25/) — canonical spec with all wire format details
