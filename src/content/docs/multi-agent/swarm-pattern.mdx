...
gpt4o = ChatOpenAI(model="gpt-5.5")
gpt4o_mini = ChatOpenAI(model="gpt-5.4")
...
<Callout type="warn">
  Swarms without cycle prevention will loop indefinitely when handoff conditions overlap between
  agents. Always identify terminal agents before deploying a swarm.
</Callout>
