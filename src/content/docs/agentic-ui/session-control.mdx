...
CopilotKit's AG-UI is the current de facto layer for streaming agent state and steering events to a UI across vendors; see the [Emerging Standards Watchlist](/docs/protocols/emerging-standards) for its status.
