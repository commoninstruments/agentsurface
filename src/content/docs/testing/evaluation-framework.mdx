...
- [ ] End state is verified for task completion, instead of only the final tool call
- [ ] Grader type matches the output type (code-based for deterministic outputs, model-based for open-ended)
- [ ] pass@k and pass^k are both measured alongside success rate
