...
Framework: Next.js 14 # But upgraded to Next.js 16
...
Next.js 16 # Last verified 2026-04-10 — recently updated
...
- Major version upgrades (Next.js 14 → 16)
...
```
docs(AGENTS.md): Update Next.js version to 16

- Verified all dev commands work with Next.js 16
...
If using Node `` `<20` ``, install node-gyp separately:
npm install -g node-gyp

(Node `` `<20` `` no longer supported — Next.js 16 requires 20+; .nvmrc enforces 20+)
```
...
Node.js 20.12+. Enforced in .nvmrc.
```
